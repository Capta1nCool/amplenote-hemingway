  ...
  noteOption: {
    "format note": {
      ...
      run: async function (app, noteUUID) {
        ...
        await this._loadRecordRTC("https://cdnjs.cloudflare.com/ajax/libs/showdown/<version tag>/showdown.min.js")
        ...
        paragraphs.forEach(p => {
          ...
          // Highlight complex words in pink
          p.innerHTML = p.innerHTML.replace(complexPattern, '<mark style="background-color:#2C1021;color:#E5569E;"> $& </mark>');
        });
